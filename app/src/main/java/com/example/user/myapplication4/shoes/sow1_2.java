...
public class sow1_2 extends AppCompatActivity {
    Spinner sp1;
    Spinner sp2;
    ImageView imageView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sow1_2);
...
//          只寫THIS會被當成LISTENER的內部類別所以要填MainActivity.this才是主要類別
                    Toast.makeText(sow1_2.this, ((TextView) view).getText(), Toast.LENGTH_SHORT).show();
...
//購買頁面的動畫
        private void playFrameAnimation(){
            imageView.setBackgroundResource(R.drawable.sow1_1anim);
