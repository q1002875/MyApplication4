...
public class spm1_3 extends AppCompatActivity {
    Spinner sp1;
    Spinner sp2;
    ImageView imageView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spm1_3);
...
//          只寫THIS會被當成LISTENER的內部類別所以要填MainActivity.this才是主要類別
                    Toast.makeText(spm1_3.this, ((TextView) view).getText(), Toast.LENGTH_SHORT).show();
...
//購買頁面的動畫
        private void playFrameAnimation(){
            imageView.setBackgroundResource(R.drawable.sow1_3anim);
