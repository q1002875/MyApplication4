...
public class shoes1_2 extends AppCompatActivity {
    Spinner sp1;
    Spinner sp2;
    ImageView imageView;
...
//          只寫THIS會被當成LISTENER的內部類別所以要填MainActivity.this才是主要類別
                    Toast.makeText(shoes1_2.this, ((TextView) view).getText(), Toast.LENGTH_SHORT).show();
    ...
    public void buy(View v) {
        if (size2 == 0) {
            ...
            if (amount2 == 0)
                ...
                settings.edit()
                        .putString("第二鞋子","高跟鞋"+Money+"元"+size+"吋"+amount+"雙")
                        .putString("第二雙","222")

                        .commit();

                Toast.makeText(shoes1_2.this, "已放置購物車", Toast.LENGTH_SHORT).show();
...
//                           startActivity(intentt);
                ...
                Intent intent = new Intent(shoes1_2.this,Third.class);
                Bundle bundle = new Bundle();
                bundle.putString("KEY_HEIGHT","456");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.navigation_home:
                getWindow().setWindowAnimations(0);
                Intent in = new Intent(shoes1_2.this, First.class);

                startActivity(in);
                return true;
            case R.id.navigation_dashboard:

                Intent intent = new Intent(shoes1_2.this, Second.class);

                startActivity(intent);
                return true;
            case R.id.navigation_notifications:
                Intent i = new Intent(shoes1_2.this, Third.class);

                startActivity(i);
            case R.id.action_settings:
                Intent iE = new Intent(shoes1_2.this, Third.class);
                startActivity(iE);
